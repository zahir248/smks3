...
<section class="py-5" style="background:#d8f9ff;" id="barisan">
    <div class="container">
...
<!-- Maklumat Berkaitan -->
<section class="py-5" style="background:#d8f9ff;" id="info">
    <div class="container">
...
<section class="py-5" style="background:#d8f9ff;" id="barisan">
    <div class="container">
        ...
        <!-- ✅ ONLY THIS PART CHANGED (FROM HARD CODE → DATABASE) -->
        <div class="text-center">
            <?php foreach($images as $img): ?>
                <img 
                    src="uploads/pemimpin_murid/<?= htmlspecialchars($img['image']) ?>" 
                    alt="Barisan Pemimpin Murid" 
...
<!-- Maklumat Berkaitan (KEKAL 100% TAK UBAH) -->
<section class="py-5" style="background:#d8f9ff;" id="info">
    <div class="container">
        <h3 class="fw-bold text-center mb-5">Maklumat Berkaitan</h3>
