...
function smks3_seo_page_descriptions(): array
{
    ...
    return [
        ...
        'bank-soalan-upsa-bck' => "Bank soalan UPSA BCK {$brand} (SMKS3).",
        'bank-soalan-upsa-bm' => "Bank soalan UPSA BM {$brand} (SMKS3).",
        'penggubal-soalan-upsa-uasa' => "Penggubal soalan UPSA dan UASA {$brand} (SMKS3).",
        'upsa-2026' => "UPSA 2026 {$brand} (SMKS3).",
        'unit-pbd' => "Unit PBD {$brand} (SMKS3).",
        'maklumat-pbd-panduan' => "Maklumat PBD dan panduan {$brand} (SMKS3).",
        'pbd-ppt' => "PBD PPT {$brand} (SMKS3).",
        'pbd-uasa' => "PBD UASA {$brand} (SMKS3).",
        'pbd-uasa-individu' => "PBD UASA Individu {$brand} (SMKS3).",
        'pbd-penjaminan-kualiti' => "Penjaminan Kualiti PBD {$brand} (SMKS3).",
        'pbd-pk-pemantauan' => "Pemantauan PBD {$brand} (SMKS3).",
        'pbd-pk-pementoran' => "Pementoran PBD {$brand} (SMKS3).",
        'pbd-pk-pengesanan' => "Pengesanan PBD {$brand} (SMKS3).",
        'pbd-pk-penyelarasan' => "Penyelarasan PBD {$brand} (SMKS3).",
        'pbd-ppt-tingkatan-1' => "PBD Tingkatan 1 {$brand} (SMKS3).",
        'pbd-ppt-tingkatan-1-individu' => "PBD Tingkatan 1 Individu {$brand} (SMKS3).",
        'pbd-ppt-tingkatan-2' => "PBD Tingkatan 2 {$brand} (SMKS3).",
        'pbd-ppt-tingkatan-2-individu' => "PBD Tingkatan 2 Individu {$brand} (SMKS3).",
        'pbd-ppt-tingkatan-3' => "PBD Tingkatan 3 {$brand} (SMKS3).",
        'pbd-ppt-tingkatan-3-individu' => "PBD Tingkatan 3 Individu {$brand} (SMKS3).",
        'pbd-ppt-tingkatan-4' => "PBD Tingkatan 4 {$brand} (SMKS3).",
        'pbd-ppt-tingkatan-4-individu' => "PBD Tingkatan 4 Individu {$brand} (SMKS3).",
        'pbd-ppt-tingkatan-5' => "PBD Tingkatan 5 {$brand} (SMKS3).",
        'pbd-ppt-tingkatan-5-individu' => "PBD Tingkatan 5 Individu {$brand} (SMKS3).",
    ];
}
