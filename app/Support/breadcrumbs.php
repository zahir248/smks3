...
{
    static $landing = [
        'Pengurusan Dan Pentadbiran' => 'profil-sekolah',
        'Kurikulum' => 'pentaksiran-peperiksaan',
        'Hal Ehwal Murid' => 'enrolmen-murid',
        'Kokurikulum' => 'unit-badan-beruniform',
        'PIBG' => 'jawatankuasa-pibg',
    ];
...
function smks3_default_breadcrumb_items(string $currentPage, string $pageTitle): array
{
    ...
    static $map = [
        ...
        'pbd-uasa' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],'PBD UASA'],
        'pbd-uasa-individu' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['PBD UASA', 'pbd-uasa'],'PBD INDIVIDU'],
        'pbd-penjaminan-kualiti' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],'Penjaminan Kualiti PBD'],
        'pbd-pk-pemantauan' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['Penjaminan Kualiti PBD', 'pbd-penjaminan-kualiti'],'Pemantauan'],
        'pbd-pk-pementoran' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['Penjaminan Kualiti PBD', 'pbd-penjaminan-kualiti'],'Pementoran'],
        'pbd-pk-pengesanan' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['Penjaminan Kualiti PBD', 'pbd-penjaminan-kualiti'],'Pengesanan'],
        'pbd-pk-penyelarasan' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['Penjaminan Kualiti PBD', 'pbd-penjaminan-kualiti'],'Penyelarasan'],
        'pbd-ppt-tingkatan-1' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['PBD PPT', 'pbd-ppt'],'PBD Tingkatan 1'],
        'pbd-ppt-tingkatan-1-individu' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['PBD PPT', 'pbd-ppt'],['PBD Tingkatan 1', 'pbd-ppt-tingkatan-1'],'PBD INDIVIDU'],
        'pbd-ppt-tingkatan-2' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['PBD PPT', 'pbd-ppt'],'PBD Tingkatan 2'],
        'pbd-ppt-tingkatan-2-individu' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['PBD PPT', 'pbd-ppt'],['PBD Tingkatan 2', 'pbd-ppt-tingkatan-2'],'PBD INDIVIDU'],
        'pbd-ppt-tingkatan-3' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['PBD PPT', 'pbd-ppt'],'PBD Tingkatan 3'],
        'pbd-ppt-tingkatan-3-individu' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['PBD PPT', 'pbd-ppt'],['PBD Tingkatan 3', 'pbd-ppt-tingkatan-3'],'PBD INDIVIDU'],
        'pbd-ppt-tingkatan-4' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['PBD PPT', 'pbd-ppt'],'PBD Tingkatan 4'],
        'pbd-ppt-tingkatan-4-individu' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['PBD PPT', 'pbd-ppt'],['PBD Tingkatan 4', 'pbd-ppt-tingkatan-4'],'PBD INDIVIDU'],
        'pbd-ppt-tingkatan-5' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['PBD PPT', 'pbd-ppt'],'PBD Tingkatan 5'],
        'pbd-ppt-tingkatan-5-individu' => ['Kurikulum',['Pentaksiran Dan Peperiksaan', 'pentaksiran-peperiksaan'],['Unit PBD', 'unit-pbd'],['PBD PPT', 'pbd-ppt'],['PBD Tingkatan 5', 'pbd-ppt-tingkatan-5'],'PBD INDIVIDU'],
        'pusat-sumber' => ['Kurikulum', 'Pusat Sumber Sekolah'],
        'pra-sekolah' => ['Kurikulum', 'Pra Sekolah'],
        'kecemerlangan-program-akademik' => ['Kurikulum', 'Program Kecemerlangan Akademik'],
        ...
        // PIBG
        'jawatankuasa-pibg' => ['PIBG', 'Jawatankuasa PIBG'],
