                ...
                <div class="panel-card">
                    ...
                    <div class="panel-card__body">
                        ...
                        <p class="mb-3">
                            ...
                            <a class="text-decoration-none" href="tel:<?= preg_replace('/\s+/', '', (string)($settings['phone'] ?? '')) ?>"><?= htmlspecialchars($settings['phone'] ?? '') ?></a>
                        </p>
                        <p class="mb-0">
                            <i class="bi bi-envelope text-primary me-2"></i>
                            <a class="text-decoration-none" href="mailto:<?= htmlspecialchars($settings['email'] ?? '') ?>"><?= htmlspecialchars($settings['email'] ?? '') ?></a>
                        </p>
                    </div>
                </div>
            </div>
